                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6 d-flex align-items-stretch">
                                    <div class="contact-wrap w-100 p-md-5 p-4 py-5">
                                        ...
                                        <form method="POST" id="contactForm" name="contactForm" class="contactForm" action="signupDB.php" onsubmit="onSubmit(this)">
                                            <div class="row">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="role">
                                                            ...
                                                            <option id="Enseignant" value="Enseignant">Enseigant</option>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="submit" value="Creer compte" class="btn btn-primary">
